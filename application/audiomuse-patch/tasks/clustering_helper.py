...
def _perform_single_clustering_iteration(
    ...
    try:
        ...
        # 2-6. Run with bounded BLAS thread pool to avoid fork+OpenBLAS deadlock.
        # OpenBLAS lazy-inits its thread pool on the first BLAS call; limiting it here
        # ensures the pool is created cleanly in the child process after fork().
